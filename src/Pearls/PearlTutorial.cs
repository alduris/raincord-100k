namespace Raincord100k.Pearls
{
    internal class PearlTutorial : UpdatableAndDeletable
    {
        ...
        public override void Update(bool eu)
        {
            ...
            room.game.cameras[0].hud.textPrompt.AddMessage(room.game.manager.rainWorld.inGameTranslator.Translate("Double tap SPECIAL while a pearl reading is playing to stop it"), 40, 190, false, true);
            Destroy();
        }
    }
}
