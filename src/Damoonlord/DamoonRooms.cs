...
namespace Raincord100k.Damoonlord
{
    public static class DamoonRooms
    {
        public static void EnableHooks()
        {
            On.MoreSlugcats.OEsphere.AddToContainer += DamoonRooms.OESphereFix;
            On.ShelterDoor.ShelterEntranceOverrides += DamoonRooms.ShelterEntrance;
            On.HUD.HUD.InitSinglePlayerHud += DamoonRooms.ShelterHUDInit;
            On.HUD.HUD.Update += DamoonRooms.ShelterHUDHide;
        }

        public static void EnableILHooks()
        {
            IL.Player.Update += DamoonRooms.ShelterCheck;
            IL.HUD.FoodMeter.MeterCircle.Update += DamoonRooms.ShelterHUD;
        }
		...
		public static void ShelterHUDHide(On.HUD.HUD.orig_Update orig, HUD.HUD self)
        {
            orig(self);
        ...
        public static void ShelterHUDInit(On.HUD.HUD.orig_InitSinglePlayerHud orig, HUD.HUD self, RoomCamera cam)
        {
            orig(self, cam);
        ...
        public static IntVector2? ShelterEntrance(On.ShelterDoor.orig_ShelterEntranceOverrides orig, ShelterDoor self)
        {
        ...
        public static void ShelterHUD(ILContext il)
        {
            try
            {
                ...
                c.EmitDelegate(ValidGateLocationFoodHUD);
            ...
            {
                BepInEx.Logging.Logger.CreateLogSource("Raincord100k - DamoonRooms").LogError(e);
            }
        }
        ...
        public static void ShelterCheck(ILContext il)
        {
            try
            {
                ILCursor c = new ILCursor(il);
                ...
                c.EmitDelegate(ValidGateLocation);
